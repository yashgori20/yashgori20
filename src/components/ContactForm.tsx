...
const ContactForm = () => {
  ...
  return (
    <div className="bg-[#2a2a2a] border border-gray-700/30 rounded-lg p-6 h-full">
      <h3 className="font-sans text-xl font-semibold text-center mb-6 text-white">Get In Touch</h3>
