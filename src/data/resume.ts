  ...
  projects: [
    {
      ...
      description: "AI-powered quality control platform with OCR digitization achieving 95% field extraction accuracy.",
    ...
    },
    {
      ...
      description: "FAISS-powered document Q&A system handling 100+ page documents with Flutter frontend.",
